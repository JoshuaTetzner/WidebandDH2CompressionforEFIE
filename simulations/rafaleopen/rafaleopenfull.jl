...
## -----------------------------------------------------------------------------
filename = "rafale_opennose_0.025"
meshpath = "/home/jt286/Documents/Geometries/rafaleopen/$(filename).msh"
...
jldsave(
    joinpath(@__DIR__, "../..", "results", "openrafale_$(numfunctions(X))_640h.jld2"); u
)
##
...
vtk_grid(
    joinpath(@__DIR__, "../..", "results", "openrafale_$(numfunctions(X))_640h"),
    vertexarray(Γ)',
    cellV,
) do vtk
