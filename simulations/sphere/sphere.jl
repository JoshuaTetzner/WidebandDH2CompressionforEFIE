...
filename = pwd() * "/results/icosphereiaca.csv"
CSV.write(filename, df)
##

for reff in [28, 40, 60, 80, 120]#[0.05, 0.035, 0.025, 0.017, 0.0125, 0.01]#
    Γ = meshicosphere(reff, 1.0)#meshsphere(1.0, reff)#
    ...
    simfull(filename, A, space, space, tree, isnear; tol=tol, ηhf=ηhf, γ=γ)
end
